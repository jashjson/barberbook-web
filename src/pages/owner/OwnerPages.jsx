...
import { shops as shopsApi, barbers as barbersApi, shopBarbers as shopBarbersApi, bookings as bookingsApi, storage } from '../../lib/supabase'
    ...
    <div className="page-inner">
            ...
            {profile?.avatar_url ? (
              <img 
                ...
                style={{
                  ...
                  borderRadius: '50%',
                  objectFit: 'cover',
                  border: '3px solid rgba(61,189,125,0.15)'
                }}
              />
            ) : (
              <div 
                className="avatar av-green" 
                style={{ 
                  width: 76, 
                  height: 76, 
                  fontSize: 24,
            ...
            <>
              <div style={{ textAlign: 'center', width: '100%' }}>
                ...
                <div style={{ display: 'flex', gap: 8, alignItems: 'center', justifyContent: 'center', marginTop: 10 }}>
                  <span className="badge badge-green" style={{ fontSize: 10.5, padding: '3px 10px' }}>Shop Owner</span>
                  <button 
                    className="btn btn-ghost btn-sm" 
      ...
      <div className="card" style={{ padding: '6px 12px' }}>
        {[
          ...
          { icon: 'info',  label: 'Help & Support', sub: 'Contact us at help@barberbook.co.in', href: null },
        ].map((item, i) => (
          <div 
            key={i} 
          ...
          >
            <div className="profile-menu-icon"><Icon name={item.icon} size={16} color="var(--green)" /></div>
